...
# Função para gerar a mensagem bíblica com o novo estilo
def gerar_mensagem_biblica():
    ...
    try:
        ...
        # PROMPT ATUALIZADO: Foco no estilo de escrita, profundidade e informalidade.
        prompt = """
        ...
        generation_config = {
            "temperature": 0.75, # Aumentei um pouco para mais criatividade
            "top_p": 1,
            "top_k": 1,
...
# Função para enviar a mensagem via Telegram (sem alterações)
...
# Bloco principal que executa o script (sem alterações)
